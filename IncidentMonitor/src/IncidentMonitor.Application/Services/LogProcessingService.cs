...
public sealed class LogProcessingService
{
    ...
    // How many minutes of history to load for anomaly detection
        ...
        CancellationToken ct = default)
    {
        ...
        foreach (var service in services)
        {
            ...
            var result = _anomalyDetector.Analyze(service, recentLogs);
